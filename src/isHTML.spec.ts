...
test("should match a text that starts with < and ends with >", () => {
...
test("should not match text that contains uppercase tags", () => {
    const text = html`
        <!-- prettier-ignore -->
        <Head>
            <title>
...
test("should match long HTML snippet", () => {
    /**
     * Code was taken from the Tailwind UI free samples:
